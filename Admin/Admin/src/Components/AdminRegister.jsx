...
import { useRegisterMutation } from '../Slice/AdminApiSlice'
...
const AdminRegister = () => {
 const [name, setName] = useState('');
  ...
  return (
    <div>
    <section className="min-h-screen flex items-center justify-center lg:mt-20 mb-24">
    <div className="bg-gray-100 flex flex-col md:flex-row rounded-2xl shadow-lg max-w-4xl p-5 items-center w-full md:w-auto">
      <div className="w-full md:w-1/2 px-4 md:px-16">
        <h2 className="font-bold text-2xl text-[#002D74]">Register Admin Profile</h2>
        <p className="text-xs mt-4 text-[#002D74]">Register your profile information</p>
