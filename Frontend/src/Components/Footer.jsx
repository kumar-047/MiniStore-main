        ...
        <div className="bg-white border border-gray-300 rounded-lg shadow-lg p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-16">
            <div className="flex flex-col justify-center items-start text-black">
              ...
              <p className="mb-4">MiniStore Online shopping store , Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
              <p className="mb-4">Phone: 2343432455</p>
              <p>Email: support@ministore.com</p>
