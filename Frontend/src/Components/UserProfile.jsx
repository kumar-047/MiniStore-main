...
const UserProfile = () => {
  ...
  // Populate form fields when userInfo is available
  useEffect(() => {
    if (userInfo) {
    ...
    <section className="min-h-screen flex items-center justify-center mt-20 mb-24">
      <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-4xl p-5 items-center">
        <div className="md:w-1/2 px-8 md:px-16">
          <h2 className="font-bold text-2xl text-[#002D74]">Profile</h2>
          <p className="text-xs mt-4 text-[#002D74]">You Can Update Your Profile</p>
